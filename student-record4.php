...
<body>
    ...
    <hr>
    <span style="text-align: center;">
        <h2>Activities & Meals (Day 22-30)</h2>
    </span>
    <hr>
    <table>
        <tr>
        ...
        <td>
     <?php 
     $sql_daily_activities = "SELECT exercises,exercise_acknowledge, id FROM program_records WHERE student_id = '$id' LIMIT 21, 7";
    ...
    <td>
    <?php
    $sql_program_records = "SELECT * FROM program_records WHERE student_id = '$id' LIMIT 21,7";
